...
func verifyTPMFormat(att AttestationObject, clientDataHash []byte) (string, []interface{}, error) {
	...
	case webauthncose.EC2PublicKeyData:
		...
		if pubArea.ECCParameters.CurveID != CoseCurveToTpmCurve(webauthncose.COSEEllipticCurve(e.Curve)) ||
...
var COSECurveToTPMCurve = []struct {
	...
	tpmCurve  googletpm.EllipticCurve
}{
	{webauthncose.P256, googletpm.CurveNISTP256},
	{webauthncose.P384, googletpm.CurveNISTP384},
...
func CoseCurveToTpmCurve(coseCurve webauthncose.COSEEllipticCurve) googletpm.EllipticCurve {
	...
	return googletpm.EllipticCurve(0)
}
