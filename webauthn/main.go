// This package contains the API functionality of the library. After creating and
// configuring a webauthn object, users can call the object to
// create and validate web authentication credentials.
package webauthn
